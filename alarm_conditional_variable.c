...
void alarm_insert (alarm_t *alarm) {
  ...
  */
  ...
  /*
    ...
    ("next" is NULL, and "last points to the link field of the last item, or to the list header.")
  ...
  */
  ...
  /*
    ...
    is 0, signifying that it's waiting for work), or if the new alarm 
    comes before the one on which the alarm thread is waiting
...
// The alarm threads's start routine
void *alarm_thread (void *arg) {
  ...
  /*
    ...
    be disintergrated when the process exists. Lock the mutex
  ...
  */
  ...
  while (1) {
    /*
      ...
      Setting current_alarm to 0 informs the insert routine 
      that the thread is not busy.
...
int main (int argc, char *argv[]) {
  ...
  while (1) {
    ...
    /* 
      Parse input lines into seconds (%d) and a message
      (%64[^\n]), consisting of up to 64 characters separated
      from the seconds by whitspace.
    */
